...
//         'https://netflix-clone-5ayq.onrender.com/api/auth/check-email',
//         {
//           method: 'POST',
//           headers: {
...
export default function Signup() {
  ...
  return (
    <div className="auth-page">
      ...
      <div className="auth-page__nav">
        <Link to="/" className="netflix-wordmark">
          NETFLIX
        </Link>
      </div>
      ...
      <div className="auth-page__card">
        ...
        {step === 1 && (
          <div className="signup-step">
            ...
            <p className="signup-step__counter">
              Step 1 of 3
            </p>

            <h2 className="signup-step__heading">
